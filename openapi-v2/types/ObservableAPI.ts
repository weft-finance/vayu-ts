...
export class ObservableAuthenticationApi {
     ...
     * @param loginRequest
     */
    public loginWithHttpInfo(loginRequest: LoginRequest, _options?: ConfigurationOptions): Observable<HttpInfo<Login200Response>> {
     ...
     * @param loginRequest
     */
    public login(loginRequest: LoginRequest, _options?: ConfigurationOptions): Observable<Login200Response> {
...
export class ObservableCustomersApi {
     ...
     */
    public createCustomerWithHttpInfo(aPICreateCustomerPayload: APICreateCustomerPayload, _options?: ConfigurationOptions): Observable<HttpInfo<APICustomer>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPICreateCustomerPayload - The details of the customer to create.
     */
    public createCustomer(aPICreateCustomerPayload: APICreateCustomerPayload, _options?: ConfigurationOptions): Observable<APICustomer> {
     ...
     */
    public deleteCustomerWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the customer to delete.
     */
    public deleteCustomer(id: string, _options?: ConfigurationOptions): Observable<void> {
     ...
     */
    public getCustomerWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APICustomer>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the customer to fetch.
     */
    public getCustomer(id: string, _options?: ConfigurationOptions): Observable<APICustomer> {
     ...
     */
    public queryCustomersWithHttpInfo(aPIQueryPayloadAPICustomer: APIQueryPayloadAPICustomer, _options?: ConfigurationOptions): Observable<HttpInfo<QueryResultAPICustomer>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPIQueryPayloadAPICustomer - The query filters and pagination options.
     */
    public queryCustomers(aPIQueryPayloadAPICustomer: APIQueryPayloadAPICustomer, _options?: ConfigurationOptions): Observable<QueryResultAPICustomer> {
     ...
     */
    public updateACustomersProductWithHttpInfo(body: ReviseEntitlementPayload, id: string, productId: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIEntitlement>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param productId - The ID of the product to revise.
     */
    public updateACustomersProduct(body: ReviseEntitlementPayload, id: string, productId: string, _options?: ConfigurationOptions): Observable<APIEntitlement> {
     ...
     */
    public updateCustomerWithHttpInfo(aPIUpdateCustomerPayload: APIUpdateCustomerPayload, id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APICustomer>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the customer to update.
     */
    public updateCustomer(aPIUpdateCustomerPayload: APIUpdateCustomerPayload, id: string, _options?: ConfigurationOptions): Observable<APICustomer> {
...
export class ObservableEntitlementsApi {
     ...
     */
    public deleteEntitlementWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the entitlement to delete.
     */
    public deleteEntitlement(id: string, _options?: ConfigurationOptions): Observable<void> {
     ...
     */
    public getEntitlementWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIEntitlement>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the entitlement to fetch.
     */
    public getEntitlement(id: string, _options?: ConfigurationOptions): Observable<APIEntitlement> {
     ...
     */
    public queryEntitlementsWithHttpInfo(aPIQueryPayloadAPIEntitlement: APIQueryPayloadAPIEntitlement, _options?: ConfigurationOptions): Observable<HttpInfo<QueryResultAPIEntitlement>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPIQueryPayloadAPIEntitlement - The query filters and pagination options.
     */
    public queryEntitlements(aPIQueryPayloadAPIEntitlement: APIQueryPayloadAPIEntitlement, _options?: ConfigurationOptions): Observable<QueryResultAPIEntitlement> {
...
export class ObservableEventsApi {
     ...
     */
    public deleteEventWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the event to delete.
     */
    public deleteEvent(id: string, _options?: ConfigurationOptions): Observable<void> {
     ...
     */
    public getEventWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIEvent>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the event to fetch.
     */
    public getEvent(id: string, _options?: ConfigurationOptions): Observable<APIEvent> {
     ...
     */
    public ingestEventToTheSystemWithHttpInfo(aPIIngestEventPayload: Array<APIIngestEventPayload>, _options?: ConfigurationOptions): Observable<HttpInfo<IngestEventToTheSystem201Response>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPIIngestEventPayload - The events to ingest
     */
    public ingestEventToTheSystem(aPIIngestEventPayload: Array<APIIngestEventPayload>, _options?: ConfigurationOptions): Observable<IngestEventToTheSystem201Response> {
     ...
     */
    public queryEventsWithHttpInfo(aPIQueryPayloadAPIEvent: APIQueryPayloadAPIEvent, _options?: ConfigurationOptions): Observable<HttpInfo<QueryResultAPIEvent>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPIQueryPayloadAPIEvent - The query filters and pagination options.
     */
    public queryEvents(aPIQueryPayloadAPIEvent: APIQueryPayloadAPIEvent, _options?: ConfigurationOptions): Observable<QueryResultAPIEvent> {
...
export class ObservableInvoicesApi {
     ...
     */
    public calculateInvoiceWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIInvoice>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the invoice to calculate.
     */
    public calculateInvoice(id: string, _options?: ConfigurationOptions): Observable<APIInvoice> {
     ...
     */
    public createInvoiceWithHttpInfo(aPICreateInvoicePayload: APICreateInvoicePayload, _options?: ConfigurationOptions): Observable<HttpInfo<APIInvoice>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPICreateInvoicePayload - The details of the invoice to create.
     */
    public createInvoice(aPICreateInvoicePayload: APICreateInvoicePayload, _options?: ConfigurationOptions): Observable<APIInvoice> {
     ...
     */
    public deleteInvoiceWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the invoice to delete.
     */
    public deleteInvoice(id: string, _options?: ConfigurationOptions): Observable<void> {
     ...
     */
    public getInvoiceWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIInvoice>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the invoice to fetch.
     */
    public getInvoice(id: string, _options?: ConfigurationOptions): Observable<APIInvoice> {
     ...
     */
    public queryInvoicesWithHttpInfo(aPIQueryPayloadAPIInvoice: APIQueryPayloadAPIInvoice, _options?: ConfigurationOptions): Observable<HttpInfo<QueryResultAPIInvoice>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPIQueryPayloadAPIInvoice - The query filters and pagination options.
     */
    public queryInvoices(aPIQueryPayloadAPIInvoice: APIQueryPayloadAPIInvoice, _options?: ConfigurationOptions): Observable<QueryResultAPIInvoice> {
     ...
     */
    public updateInvoiceWithHttpInfo(aPIUpdateInvoicePayload: APIUpdateInvoicePayload, id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIInvoice>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the invoice to update.
     */
    public updateInvoice(aPIUpdateInvoicePayload: APIUpdateInvoicePayload, id: string, _options?: ConfigurationOptions): Observable<APIInvoice> {
...
export class ObservableProductsApi {
     ...
     */
    public createProductWithHttpInfo(aPICreateProductPayload: APICreateProductPayload, _options?: ConfigurationOptions): Observable<HttpInfo<APIProduct>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPICreateProductPayload - The details of the product to create.
     */
    public createProduct(aPICreateProductPayload: APICreateProductPayload, _options?: ConfigurationOptions): Observable<APIProduct> {
     ...
     */
    public deleteProductWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<void>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the product to delete.
     */
    public deleteProduct(id: string, _options?: ConfigurationOptions): Observable<void> {
     ...
     */
    public getProductWithHttpInfo(id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIProduct>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the product to fetch.
     */
    public getProduct(id: string, _options?: ConfigurationOptions): Observable<APIProduct> {
     ...
     */
    public queryProductsWithHttpInfo(aPIQueryPayloadAPIProduct: APIQueryPayloadAPIProduct, _options?: ConfigurationOptions): Observable<HttpInfo<QueryResultAPIProduct>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param aPIQueryPayloadAPIProduct - The query filters and pagination details.
     */
    public queryProducts(aPIQueryPayloadAPIProduct: APIQueryPayloadAPIProduct, _options?: ConfigurationOptions): Observable<QueryResultAPIProduct> {
     ...
     */
    public updateProductWithHttpInfo(aPIUpdateProductPayload: APIUpdateProductPayload, id: string, _options?: ConfigurationOptions): Observable<HttpInfo<APIProduct>> {
    let _config = this.configuration;
    let allMiddleware: Middleware[] = [];
    if (_options && _options.middleware){
      const middlewareMergeStrategy = _options.middlewareMergeStrategy || 'replace' // default to replace behavior
     ...
     * @param id - The ID of the product to update.
     */
    public updateProduct(aPIUpdateProductPayload: APIUpdateProductPayload, id: string, _options?: ConfigurationOptions): Observable<APIProduct> {
