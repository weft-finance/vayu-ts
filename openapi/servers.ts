...
export const server1 = new ServerConfiguration<{  }>("https://connect.withvayu.com", {  })
export const server2 = new ServerConfiguration<{  }>("https://staging-connect.withvayu.com", {  })
