 ...
 */
export class BearerAuthorizerAuthentication implements SecurityAuthentication {
    /**
...
export function configureAuthMethods(config: AuthMethodsConfiguration | undefined): AuthMethods {
    ...
    if (config["BearerAuthorizer"]) {
        authMethods["BearerAuthorizer"] = new BearerAuthorizerAuthentication(
            config["BearerAuthorizer"]["tokenProvider"]
        );
    }
